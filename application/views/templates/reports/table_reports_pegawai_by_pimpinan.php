<table id="tableRekapPegawai" class="table">
	<thead>
...
<script>
	...
	function dataTable() {
		...
		$('#tableRekapPegawai').addClass('pt-3');
		$('#tableRekapPegawai_length').addClass('d-none d-md-block');
		$('#tableRekapPegawai_filter').addClass('d-none d-md-block');
	}
</script>